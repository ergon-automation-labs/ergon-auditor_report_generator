defmodule BotArmyAuditorReportGenerator.Skills.Example do
  @moduledoc """
  Example skill for Report Generator Bot.
  ...
  1. NATS message arrives on trigger subject: `bot.bot_army_auditor_report_generator.command.example`
  ...
  5. Result published to response subject: `bot.bot_army_auditor_report_generator.response.<request_id>`
  ...
  1. Rename: `lib/bot_army_auditor_report_generator/skills/your_skill.ex`
  ...
  def nats_triggers do
    ...
    [
      "bot.bot_army_auditor_report_generator.command.example"
    ]
  end
