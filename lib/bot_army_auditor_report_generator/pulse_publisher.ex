defmodule BotArmyAuditorReportGenerator.PulsePublisher do
  @moduledoc """
  Periodic health publisher for Report Generator Bot.
  ...
  2. **`bot.auditor_report_generator.pulse`** — richer metrics every 30 minutes (lower NATS volume).
  ...
  @service_name "auditor_report_generator"
  @envelope_source "bot_army_auditor_report_generator"
  ...
  @impl true
  def init(_opts) do
    Logger.info("[PulsePublisher] Starting Report Generator Bot pulse publisher")
