defmodule BotArmyAuditorReportGenerator.Skills.ExampleTest do
  @moduledoc """
  ...
  alias BotArmyAuditorReportGenerator.Skills.Example
  ...
  describe "nats_triggers/0" do
    test "returns list of trigger subjects" do
      ...
      assert "bot.bot_army_auditor_report_generator.command.example" in triggers
    end
  end
